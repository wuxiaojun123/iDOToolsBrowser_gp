...
-keep public class com.idotools.browser.gp.R$*{
    public static final int *;
}

#####################自定义view还有和js交互的类 不混淆 ##############
-keep class com.idotools.browser.gp.view.** { *; }
-keep class com.idotools.browser.gp.bean.** { *; }
-keep class com.idotools.browser.gp.manager.webview.BrowserJsInterface { *; }
