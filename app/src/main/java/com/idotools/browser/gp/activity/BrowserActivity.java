...
import com.idotools.browser.gp.manager.popupwindow.MainPopupWindow;
import com.idotools.browser.gp.manager.webview.WebViewManager;
import com.idotools.browser.gp.manager.webview.WebviewInteface;
...
import com.idotools.browser.gp.view.AnimatedProgressBar;
import com.idotools.browser.gp.view.BrowserWebView;
import com.idotools.browser.gp.view.SearchEditTextView;
...
public class BrowserActivity extends BaseActivity implements View.OnClickListener, WebviewInteface, OnPageStartedListener, OnReceivedErrorListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.id_iv_home:
                isPopupShowing();
                //回到native的首页
                startActivity(new Intent(BrowserActivity.this, DmzjActivity.class));
            ...
            case R.id.id_iv_refresh:
                isPopupShowing();
                refresh();
                mFirebaseAnalytics.logEvent("refresh", new Bundle());

                break;
            case R.id.id_iv_more:
                if (mPopupWindow == null) {
                    mPopupWindow = new MainPopupWindow(BrowserActivity.this);
                }
            ...
            case R.id.id_iv_history:
                //历史记录
                startActivity(new Intent(BrowserActivity.this, HistoryAndRecordsActivity.class));
                ActivitySlideAnim.slideInAnim(BrowserActivity.this);
        ...
        if (!TextUtils.isEmpty(searchEditText)) {
            if (mWebView != null && !TextUtils.equals(searchEditText, mWebView.getUrl())) {
                ...
                if (Patterns.WEB_URL.matcher(searchEditText).matches()) {
                    ...
                    loadUrl(Constant.SEARCH_URL + searchEditText);
                }
                Bundle bundle = new Bundle();
                bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "click_value");
